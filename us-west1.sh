...
gcloud notebooks instances create instance-without-gpu \
  ...
  --location=us-west1-a
  _______________________________________________________________________________________________________________________
gcloud notebooks instances list --location=us-west1-a
_______________________________________________________________________________________________________________________
...
_______________________________________________________________________________________________________________________
JUPYTERLAB_URL=`gcloud notebooks instances describe instance-without-gpu --location=us-west1-a --format='value(proxyUri)'`
